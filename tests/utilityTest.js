...
describe('Utility', () => {
  ...
  it('should calculate read time for text passage', async () => {
    const body = 'this is a dummy text, you know, similar to that lorem ipsum type of text that text autogenerators provide only this one is done by an human being';
